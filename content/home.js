...
const techTopics = [
    'computer networking', 'UX'
]

const experience = [
    {company:'InSynchro', role:'Intern Software Dev', duration:'Mar 2020 - May 2020'},
    {company:'InSynchro', role:'Associate Software Dev', duration:'Jun 2020 - Present'},
    {company:'IncubateIND', role:'GitHub Extern 2021', duration:'Jul 2021 - Oct 2021'},
    {company:'TNAU', role:'Project Intern', duration:'10 - 16 Sep 2021'},
    {company:'Next Tech Lab', role:'Member', duration:'Feb 2020 - Present'},
    {company:'Biocom', role:'Technical Domain Head', duration:'Sep 2021 - Present'}
]
...
const socialLinks = [
    ...
    {to:'stackoverflow', link:'https://stackoverflow.com/users/15961606/tanisha-bisht'},
    // {to:'npx', link:''},
